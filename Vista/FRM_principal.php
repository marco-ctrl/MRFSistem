            ...
            <div id="content">
                ...
                <div class="container-fluid" id="trabajo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="#" id="mn_respaldo" class="collapse-item" style="text-decoration:none">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Sistema:</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">RESPALDAR BD
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-map-marked fa-2x text-gray-700"></i>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="FRM_RestaurarBD" class="collapse-item" style="text-decoration:none">
                                <div class="card border-left-danger shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                    Sistema:</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">RESTAURAR BD
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-map-marked fa-2x text-gray-700"></i>
