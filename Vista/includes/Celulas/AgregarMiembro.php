            ...
            <div class="form-group">
                ...
                <div class="input-group border-bottom-danger" id="div_ci">
                    ...
                    <input type="text" id="txt_ciExtencion" placeholder="Extencion" class="form-control"
                        title="introducir extencion en caso de que tenga" onkeyup="this.value=alfaNumerico(this.value);"
    ...
    <div class="col-md-4">
        <form id="formMiecel2">
            <div class="form-group">
                ...
                <input type="text" id="txt_materno" maxlength="30" placeholder="Apellido Materno" class="form-control"
...
<div class="modal-footer">
        ...
        <button type="button" id="btn_cerrarMiecel" class="btn btn-danger" data-dismiss="modal" title="Cerrar"><i
