$(document).ready(function () {
                ...
                success: function (response) {
                    if (response != "no encontrado") {
                        ...
                        miembros.forEach(miembros => {
                            plantilla += `<option value="${miembros.pacodmie}" class="ciudad">${miembros.canommie} ${miembros.capatmie} ${miembros.camatmie}</option>`;
                        });
                        $('#sel_miembro').html(plantilla);
                    }
                    else {
                        $('#sel_miembro').html(plantilla);
        ...
        $.post('/MRFIglesiaBermejo/AccesoDatos/Usuario/SingleUsuario.php',
            { pacodusu }, function (responce) {
                ...
                miembro.forEach(miembro => {
                    ...
                    $('#sel_miembro').val(miembro.facodmie),
    ...
    $('#sel_miembro').change(function (e) {//asigar codigo profesion
        codMiembro = $('#sel_miembro').val();
        console.log("codigo profesion " + codMiembro);
        e.preventDefault();
    ...
    function GuardarUsuario() {
        console.log('contrase;a ' + $('#txt_contrasena').val());
        console.log('codido miembro ' + codMiembro);
        const postData = {
            facodmie: codMiembro,
            pacodusu: codUsuario,
    ...
    function habilitarFormulario() {
        ...
        document.getElementById("txt_buscarMiembro").focus();
    }
